...
const Body = struct {
    pub const compiled_plan = plan("static-machine-effect-row-coverage-omitted");
};
const Program = boundary.program("static-machine-effect-row-coverage-omitted", struct {}, Body);
