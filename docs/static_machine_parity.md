...
Session-local request tokens and raw continuation bytes are intentionally
...
helper suspension, malformed images, response ownership, after-continuation
checkpoints, explicit fuel yield, terminal failure, agent fixtures, and provider
fixtures:
