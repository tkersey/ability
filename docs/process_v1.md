...
generic `text_byte_at` operation over canonical UTF-8 code units while retaining
version-2 failure selection. Neither changes the BPI1 container, State format,
Process ABI, or any earlier image bytes.
